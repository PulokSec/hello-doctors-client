...
const Footer = () => {
	...
	const noNamed = [
		{ name: 'hello.doctors@gmail.com', link: '/' },
		{ name: '+8801-7566-56526', link: '/checkup' },
	...
	const ourAddress = [
		{ name: 'House-19, Road 3B,Sector 9, Uttara, Dhaka 1200', link: '//google.com/map' },
		...
		<>
			<footer className="footer-area clear-both">
				<div className="container pt-3">
					...
					<div className="copyRight text-center pb-3 text-secondary">
						<p> &copy; {(new Date()).getFullYear()} | Pulok Chowdhury</p>
					</div>
				</div>
			</footer>
			...
			>
				<form className="px-5 my-3 text-center">
					...
					<h5 className="text-secondary mb-3">Email: hello.doctors.admin@gmail.com</h5>
					<h6 className="text-secondary mb-3">Password: AdminDoctors1</h6>
                    <p className="text-center mb-2 mt-3 px-5">
						<small>Or you can add new admin after login to this credentials </small>
					</p>
